create table "public"."ddx_phase_types" (
...
alter table "public"."ddx_phase_types" enable row level security;

create table "public"."ddx_use_types" (
    "id" bigint generated by default as identity not null,
    "created_at" timestamp with time zone not null default now(),
    "ddx_use_type" text,
    "baseline_eui" real
...
alter table "public"."ddx_use_types" enable row level security;

alter table "public"."enum_project_phases" add column "ddx_phase_type_id" bigint;

alter table "public"."enum_project_use_types" add column "ddx_use_type_id" bigint;

alter table "public"."uploads" add column "custom_project_id" text;

CREATE UNIQUE INDEX ddx_phase_types_pkey ON public.ddx_phase_types USING btree (id);

CREATE UNIQUE INDEX ddx_use_types_pkey ON public.ddx_use_types USING btree (id);

alter table "public"."ddx_phase_types" add constraint "ddx_phase_types_pkey" PRIMARY KEY using index "ddx_phase_types_pkey";

alter table "public"."ddx_use_types" add constraint "ddx_use_types_pkey" PRIMARY KEY using index "ddx_use_types_pkey";

alter table "public"."enum_project_phases" add constraint "enum_project_phases_ddx_phase_type_id_fkey" FOREIGN KEY (ddx_phase_type_id) REFERENCES ddx_phase_types(id) not valid;

alter table "public"."enum_project_phases" validate constraint "enum_project_phases_ddx_phase_type_id_fkey";

alter table "public"."enum_project_use_types" add constraint "enum_project_use_types_ddx_use_type_id_fkey" FOREIGN KEY (ddx_use_type_id) REFERENCES ddx_use_types(id) not valid;

alter table "public"."enum_project_use_types" validate constraint "enum_project_use_types_ddx_use_type_id_fkey";

create or replace view "public"."project_energy_summary2" as  WITH ranked_uploads AS (
...
grant delete on table "public"."ddx_phase_types" to "anon";

grant insert on table "public"."ddx_phase_types" to "anon";

grant references on table "public"."ddx_phase_types" to "anon";

grant select on table "public"."ddx_phase_types" to "anon";

grant trigger on table "public"."ddx_phase_types" to "anon";

grant truncate on table "public"."ddx_phase_types" to "anon";

grant update on table "public"."ddx_phase_types" to "anon";

grant delete on table "public"."ddx_phase_types" to "authenticated";

grant insert on table "public"."ddx_phase_types" to "authenticated";

grant references on table "public"."ddx_phase_types" to "authenticated";

grant select on table "public"."ddx_phase_types" to "authenticated";

grant trigger on table "public"."ddx_phase_types" to "authenticated";

grant truncate on table "public"."ddx_phase_types" to "authenticated";

grant update on table "public"."ddx_phase_types" to "authenticated";

grant delete on table "public"."ddx_phase_types" to "service_role";

grant insert on table "public"."ddx_phase_types" to "service_role";

grant references on table "public"."ddx_phase_types" to "service_role";

grant select on table "public"."ddx_phase_types" to "service_role";

grant trigger on table "public"."ddx_phase_types" to "service_role";

grant truncate on table "public"."ddx_phase_types" to "service_role";

grant update on table "public"."ddx_phase_types" to "service_role";

grant delete on table "public"."ddx_use_types" to "anon";

grant insert on table "public"."ddx_use_types" to "anon";

grant references on table "public"."ddx_use_types" to "anon";

grant select on table "public"."ddx_use_types" to "anon";

grant trigger on table "public"."ddx_use_types" to "anon";

grant truncate on table "public"."ddx_use_types" to "anon";

grant update on table "public"."ddx_use_types" to "anon";

grant delete on table "public"."ddx_use_types" to "authenticated";

grant insert on table "public"."ddx_use_types" to "authenticated";

grant references on table "public"."ddx_use_types" to "authenticated";

grant select on table "public"."ddx_use_types" to "authenticated";

grant trigger on table "public"."ddx_use_types" to "authenticated";

grant truncate on table "public"."ddx_use_types" to "authenticated";

grant update on table "public"."ddx_use_types" to "authenticated";

grant delete on table "public"."ddx_use_types" to "service_role";

grant insert on table "public"."ddx_use_types" to "service_role";

grant references on table "public"."ddx_use_types" to "service_role";

grant select on table "public"."ddx_use_types" to "service_role";

grant trigger on table "public"."ddx_use_types" to "service_role";

grant truncate on table "public"."ddx_use_types" to "service_role";

grant update on table "public"."ddx_use_types" to "service_role";
