create table "public"."enum_use_type_subtypes" (
...
alter table "public"."enum_use_type_subtypes" enable row level security;

alter table "public"."enum_project_use_types" add column "has_subtypes" boolean default false;

alter table "public"."uploads" add column "use_type_subtype_id" bigint;

CREATE UNIQUE INDEX enum_sub_use_types_pkey ON public.enum_use_type_subtypes USING btree (id);

alter table "public"."enum_use_type_subtypes" add constraint "enum_sub_use_types_pkey" PRIMARY KEY using index "enum_sub_use_types_pkey";

alter table "public"."enum_use_type_subtypes" add constraint "public_enum_sub_use_types_use_type_id_fkey" FOREIGN KEY (use_type_id) REFERENCES enum_project_use_types(id) not valid;

alter table "public"."enum_use_type_subtypes" validate constraint "public_enum_sub_use_types_use_type_id_fkey";

alter table "public"."uploads" add constraint "public_uploads_use_type_subtype_fkey" FOREIGN KEY (use_type_subtype_id) REFERENCES enum_use_type_subtypes(id) not valid;

alter table "public"."uploads" validate constraint "public_uploads_use_type_subtype_fkey";
...
grant delete on table "public"."enum_use_type_subtypes" to "anon";

grant insert on table "public"."enum_use_type_subtypes" to "anon";

grant references on table "public"."enum_use_type_subtypes" to "anon";

grant select on table "public"."enum_use_type_subtypes" to "anon";

grant trigger on table "public"."enum_use_type_subtypes" to "anon";

grant truncate on table "public"."enum_use_type_subtypes" to "anon";

grant update on table "public"."enum_use_type_subtypes" to "anon";

grant delete on table "public"."enum_use_type_subtypes" to "authenticated";

grant insert on table "public"."enum_use_type_subtypes" to "authenticated";

grant references on table "public"."enum_use_type_subtypes" to "authenticated";

grant select on table "public"."enum_use_type_subtypes" to "authenticated";

grant trigger on table "public"."enum_use_type_subtypes" to "authenticated";

grant truncate on table "public"."enum_use_type_subtypes" to "authenticated";

grant update on table "public"."enum_use_type_subtypes" to "authenticated";

grant delete on table "public"."enum_use_type_subtypes" to "service_role";

grant insert on table "public"."enum_use_type_subtypes" to "service_role";

grant references on table "public"."enum_use_type_subtypes" to "service_role";

grant select on table "public"."enum_use_type_subtypes" to "service_role";

grant trigger on table "public"."enum_use_type_subtypes" to "service_role";

grant truncate on table "public"."enum_use_type_subtypes" to "service_role";

grant update on table "public"."enum_use_type_subtypes" to "service_role";
